...
const manga = [{
    ...
    link: 'Maou no Ore ga Dorei Elf wo Yome ni Shitanda ga, Dou Medereba Ii? chapter 33',
    url: '/Maou'
},
{
    ...
    link: 'My Status as an Assassin Obviously Exceeds the Brave s chapter 22',
    url: 'Assassin'
},
{
...
app.get('/Maou', (req, res) => {
    let m = manga[0]
    res.render('Maou/index', {nMaou, maouLinks, m});
});
